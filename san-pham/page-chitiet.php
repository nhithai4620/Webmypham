    ...
    <section class="product_d content_ld">
    	<div class="detailP">
            ...
            <aside class="ckProduct">
            	<div class="titile">
                	CAM KẾT KHI MUA HÀNG TẠI <span>THAO COSMETIC</span>
                    
                </div><!--titile-->
                <div class="deCk deCkTtct">
                	<span class="icon"></span><!--end icon-->
                    <span class="ttCK">Nhận hàng trong <b class="30p">30 phút</b> tại Cần Thơ (Thanh toán tiền mặt hoặc chuyển khoản)</span><!--end ttCK-->
                </div><!--deCk deCkTtct-->
