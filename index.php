...
<script src='http://localhost/webmypham/js/jquery-1.11.3.min.js' type='text/javascript'></script>
...
<div class="content">
    ...
    <div class="homenew">
    	<a  tittle="Khuyến mãi">
        	<img src="./images/uudai2.jpg" alt="Khuyến mãi" class="uudai"/>
        </a>
        <div class="figure">
            <a >BÍ QUYẾT LÀM ĐẸP</a>
            <b></b>
        </div><!--end figure-->
        <div class="image_figure">
        	<img src="images/medium-h1.jpg" atl="Bí quyết làm đẹp của phụ nữ."/>
        </div><!--end image_figure-->
    </div><!--end homenew-->
    <div class="sliderows">
    	<div class="navicate">
        	<h2 class="parent">
            	<a href="san-pham/cham-soc-da-mat.php" tittle="CHĂM SÓC DA MẶT">CHĂM SÓC DA MẶT</a>
            </h2><!--end parent-->
            <div class="sub">
    ...
    <a tittle="Bộ sản phẩm dưỡng da mặt SK-II" >
        <img class="banner_rows" src="./images/bosanphamduongdamat_2.jpg" alt="Bộ sản phẩm dưỡng da mặt"/>
    </a>
    <div class="selling">
    	<a  tittle=" Dung dịch đặc trị mụn BHA Obagi " >
        	<img class="bha_obagi" src="./images/bha_obagi.jpg" alt=" Dung dịch đặc trị mụn BHA Obagi "/>
    	</a>
    </div><!--end selling--->
    ...
    <div class="sliderows sliderows_t sliderows_red">
        ...
        <p tittle="Bộ sản Phẩm trang điểm">
        	<img class="banner_rows" src="images/baner_cc.jpg" alt="Kem Trang Điểm CC Cream Sakura"/>
			</p>
    <div class="selling">
    	<p tittle=" Mascara B.O.M làm dày và cong mi ">
        	<img class="dangmi" src="images/taodangmi.jpg" alt=" Tạo dáng mi "/>
			</p>
    </div><!--end selling--->
    <div class="row_product owl-carousel owl-theme" style="opacity:1; display:block; ">
    		<div class="owl-wrapper-outer">
    ...
    <div class="sliderows sliderows_t sliderows_blue">
        ...
        <p tittle="kem dưỡng da chống nắng L-Glutathione">
        	<img class="banner_rows" src="images/body2.jpg" alt="kem dưỡng da chống nắng L-Glutathione"/>
			</p>
    <div class="selling">
    	<p tittle=" Tẩy tế bào chết body">
        	<img class="tdcbody" src="images/tdcbody.jpg" alt="Tẩy tế bào chết body"/>
			</p>
    </div><!--end selling--->
    <div class="row_product owl-carousel owl-theme" style="opacity:1; display:block; ">
    		<div class="owl-wrapper-outer">
...
<!----------------------------------sliderows sliderows_t sliderows_hg------------------------------------------->    
    ...
    <div class="sliderows sliderows_t sliderows_hg">
        ...
        <div class="navicate2">
        <p tittle="Viên uống đặc trị nám HISPA">
        	<img class="banner_rows" src="images/banercuoi.jpg" alt="Viên uống đặc trị nám HISPA"/>
			</p>
    <div class="selling">
    	<p tittle="Viên uống vitamin E">
        	<img src="images/vienuong.jpg" alt="Viên uống vitamin E"/>
			</p>
    </div><!--end selling--->
    	</div>
...
<div class="footer">
	<div class="homeEmail">
    	<div class="container">
        	<div class="connect">
            	Liên hệ:
                <a title="Facebook Thảo Nguyễn" href="https://www.facebook.com/profile.php?id=100009354002889" rel="nofollow" target="_blank" class="fb"></a>
                <div class="backtop">
    				<b></b>
				</div><!--end backtop-->
    ...
    <div class="container">
    	<div class="link">
			...
			<ul>
            	<li><p>Thao Cosmetic shop tự hào là địa chỉ tin cậy hàng đầu </p></li>
				<li><p>cung cấp sản phẩm mỹ phẩm, dược mỹ phẩm xách tay</p></li>
				<li><p>chính hãng, chất lượng, giá tốt nhất.</p></li>
			</ul>
		</div><!--end link-->

        <div class="link call"> Liên hệ trực tiếp Thao Cosmetic shop:<br/>
        	<span class="tongtaituphone">SĐT: 0911404519 - 0812404519 (Thảo)</span><!--end tongdaituphone--><br/>
            <span class="tongtaituphone">Địa chỉ: 58 đường 3/2, p. Xuân Khánh, q. Ninh Kiều, tp. Cần Thơ</span><!--end tongdaituphone--><br/>
    ...
    Địa chỉ : 58 đường 3/2 phường Xuân Khánh, Ninh Kiều, Cần Thơ.
